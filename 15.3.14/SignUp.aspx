<%@ Page Title="Sign Up" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SignUp.aspx.cs" Inherits="SignUpV2" %>
...
function disable() {
    ...
    id: <input name="id" value="<%=id %>" id="id" onblur="javascript:disable()"/><label class="inv" id="invid"></label><br />
    first name: <input name="fname" id="fname" onblur="javascript:disable()"/><label class="inv" id="invname"></label><br />
    last name: <input name="lname" id="lname" onblur="javascript:disable()"/><label class="inv" id="invlname"></label><br />
    email: <input name="email" id="email" onblur="javascript:disable()"/><label class="inv" id="invmail"></label><br />
    phone number: <input name="phnum" id="phnum" onblur="javascript:disable()"/><label class="inv" id="invphone"></label><br />
    username: <input name="username" id="username" onblur="javascript:disable()"/><label class="inv" id="invuser"></label><br />
    password: <input name="password" id="password" onblur="javascript:disable()"/><label class="inv" id="invpass"></label><br />
    ...
    <asp:Label id="used" runat="server" ForeColor="Red"></asp:Label>
